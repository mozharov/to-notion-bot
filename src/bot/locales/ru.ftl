...
start = 🚀 Превратите Telegram в ваш второй мозг!
    ...
    ⚡ Первый месяц бесплатно, затем от $5/месяц
...
left-messages-limit-reached = ⚠️ <b>Твой бесплатный период закончился.</b>
    Оформи подписку, чтобы продолжить использовать бот без ограничений.

subscription = 🚀 <b>Подписка</b>
    Бесплатная версия бота даёт месяц пробного периода, чтобы оценить его возможности.
