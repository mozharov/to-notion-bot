...
start = 🚀 Превратите Telegram в ваш второй мозг!
    ...
    ToNotionBot поможет вам:
    📝 Сохранять важные сообщения в 1 клик
    🎯 Вести задачи прямо из чатов
    📊 Собирать материалы для проектов
    🗂 Организовать базу знаний команды
    ⚡ Моментально отправлять любой контент из Telegram в <a href="https://notion.so">Notion</a>
