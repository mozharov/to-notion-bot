...
dev-message = ⚠️<b>ЭТОТ БОТ НАХОДИТСЯ В СТАДИИ РАЗРАБОТКИ, ВСЕ ДАННЫЕ БУДУТ УДАЛЕНЫ</b>
...
subscription = <b>Статус твоей подписки:</b> {$status -> 
    ...
    {$status -> 
        ...
        *[other] 
            • {$messagesLimit} отправок сообщений в Notion в месяц

            ⚠️ Оформи подписку, чтобы снять лимиты на количество отправляемых сообщений.
    }
