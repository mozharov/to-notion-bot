...
error-too-big-file = ⚠️ Размер файла превышает максимально допустимый размер в 20 МБ.
...
set-price = <b>Установка цены подписки на {$period ->
    ...
    Отправь новую цену в <b>Telegram Stars</b>
...
donate = <b>Поддержать разработчика</b>

    Если тебе помог бот или просто жизнь стала чуточку легче, то предлагаю тебе поддержать развитие проекта любой комфортной суммой.

    Любая сумма помогает и мотивирует продолжать работу над проектом. 
    Бот полностью бесплатный и развивается исключительно за счёт донатов.

    Нажми на кнопку ниже, чтобы поддержать разработку.
    .link = Поддержать проект ❤️